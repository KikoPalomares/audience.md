...
export const metadata: Metadata = {
  title: "Specification",
  description: "Read the AudienceMD v0.1 specification rendered from the canonical SPEC.md file.",
      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-10 flex flex-col gap-4 border-b border-stone-900/10 pb-8 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-3 text-4xl font-semibold tracking-tight text-stone-950">AudienceMD v0.1 standard</h1>
          ...
          <Link className="shrink-0 text-sm font-medium text-stone-950 underline underline-offset-4" href="https://github.com/KikoPalomares/audience.md/blob/main/SPEC.md">
            Source on GitHub
          </Link>
        </div>
