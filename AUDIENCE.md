...
Use plain, builder-friendly language. Avoid corporate persona theater. Prefer concrete terms like “needs,” “constraints,” “decision criteria,” and “evidence.” Explain standards carefully but do not sound academic.
...
Current evidence is founder intuition plus recurring friction from AI-assisted work: audience context is repeatedly rewritten in prompts and often disappears between tools.
...
- How strict should the required section list be?
- Should the canonical file support multiple audience segments in one document, or encourage separate files?
- What metadata format should be recommended: YAML frontmatter, Markdown headings, JSON sidecar, or all of them?
